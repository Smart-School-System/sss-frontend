...
const DatePickerInput = (props) => {
	...
	return (
		<div className="relative w-full">
			...
			<label htmlFor="floating_outlined" className="absolute text-sm text-darkThemeTextLight dark:text-gray-400 duration-300 transform -translate-y-4 scale-100 top-2 z-10 origin-[0] bg-white dark:bg-darkTheme4 px-2 peer-focus:px-2 peer-focus:text-primaryBlue dark:peer-focus:text-darkThemeTextLight peer-focus:dark:text-darkThemeTextLight peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1 peer-focus:top-1 peer-focus:scale-95 peer-focus:-translate-y-4 left-1">
