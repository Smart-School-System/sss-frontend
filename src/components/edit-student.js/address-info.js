...
const  AddressInfo = (props) => {
	...
	return (
		<Wrapper label = { 'Address Information'} >
			<InputFloat placeholder={'Residential Address'} isDisabled={disabled} value={props.data.residential_address}/>
			<InputFloat placeholder={'Postal Address'} isDisabled={disabled} required={false} value={props.data.postal_address}/>
