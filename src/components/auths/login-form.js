...
const LoginForm = () => {
    ...
    return (
        <form onSubmit={(e) => e.preventDefault()} method='POST' className='w-full h-full space-y-5 md:w-fit md:h-auto relative flex flex-col justify-center shadow hover:shadow-xl rounded-xl items-center md:space-y-12 py-12 px-24 dark:bg-darkTheme4' style={{ transition: 'all 1s ease' }}>
